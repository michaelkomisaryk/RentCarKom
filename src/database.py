"""
database.py  –  JSON-based persistence for rentCarKom
All data lives in data/db.json (created automatically on first run).
"""
...
_DEFAULT_CARS = [
    ...
    },
    {
        ...
        "color": "Black",
        "mileage": 12000,
        "description": "Premium executive sedan with sporty handling and luxury interior.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.9,
    ...
    },
    {
        ...
        "color": "Gray",
        "mileage": 8000,
        "description": "Elegant luxury sedan with cutting-edge technology and supreme comfort.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.8,
    ...
    },
    {
        ...
        "color": "Blue",
        "mileage": 55000,
        "description": "Reliable and fuel-efficient family sedan with generous trunk space.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.1,
    ...
    },
    {
        ...
        "color": "Red",
        "mileage": 15000,
        "description": "Modern compact SUV with advanced safety features and hybrid efficiency.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.5,
        "created_at": "2024-09-12T11:00:00",
        "is_premium": False,
    },
    {
        "id": "car-007",
        ...
        "color": "Dark Blue",
        "mileage": 21000,
        "description": "Sporty premium sedan with quattro all-wheel drive and refined interior.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.7,
    ...
    },
    {
        ...
        "color": "Green",
        "mileage": 9000,
        "description": "Stylish and practical crossover with great value and modern tech.",
        "photos": [],
        "is_rented": False,
        "added_by": "admin@rentcarkom.com",
        "rating": 4.4,
        "created_at": "2024-08-22T13:00:00",
        "is_premium": False,
    },
]
...
class DB:
    ...
    def init(cls):
        ...
        cls._save()  # ensures file exists on disk

    @classmethod
    def migrate_car_metadata(cls):
        """Backfill rating, created_at, is_premium for legacy records."""
        changed = False
    ...
    def add_car(cls, data: dict) -> dict:
        car = {
            ...
            "is_premium": bool(data.get("is_premium", float(data.get("price", 0)) >= 85)),
        }
    ...
    def add_photo_to_car(
        ...
        *,
        ...
        """
        Save photo under assets/cars/<car_id>/ and store path relative to assets/
        (e.g. cars/car-abc/photo.jpg) so Flet web/desktop can load it via Image src.

        On web, FilePicker returns path=None — pass file bytes and optional name instead.
        """
    ...
    def migrate_photo_paths(cls):
        """Normalize legacy absolute paths in DB to assets-relative cars/..."""
        changed = False
        for car in cls.get_cars():
    ...
    def create_rental(
        ...
        *,
        ...
        rental = {
            ...
            "renter_name": renter_name.strip() or user["name"],
            "start_datetime": start.isoformat(),
            "end_datetime": end.isoformat(),
            "days": days,
            "price_per_day": car["price"],
            "total_price": round(car["price"] * days, 2),
