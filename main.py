...
async def main (page :ft .Page ):
    ...
    page .theme =ft .Theme (color_scheme =ft .ColorScheme (primary =ft .Colors .DEEP_PURPLE_700 ,secondary =ft .Colors .INDIGO_500 ,surface =ft .Colors .WHITE ))
...
ft .run (main ,view =ft .AppView .WEB_BROWSER ,port =_PORT ,upload_dir ='assets/uploads',assets_dir ='assets')
